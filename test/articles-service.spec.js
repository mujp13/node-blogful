...
describe(`Articles service object`, function() {
  ...
  before(() => db('blogful_articles').truncate()); // Need to clear the table so we have a fresh start every time we run the tests.

  afterEach(() => db('blogful_articles').truncate()); // Avoid test leak (one test is affecting another test, every test should clean up after itself)
  ...
  describe(`getAllArticles()`, () => {
    context(`Given 'blogful_articles' has data`, () => {
      ...
      // Test fro getting a sepcific article
